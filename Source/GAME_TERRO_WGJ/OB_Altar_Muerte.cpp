...
#include "OB_Altar_Muerte.h"
#include "UObject/ConstructorHelpers.h"
#include "Engine/Engine.h"
#include "GAME_TERRO_WGJCharacter.h"

// Sets default values
AOB_Altar_Muerte::AOB_Altar_Muerte()
{
	...
	// Load muerte particle system
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ParticleAsset(TEXT("ParticleSystem'/Game/MagicCircles2/ParticleSystems/PS_MagicCircle_19.PS_MagicCircle_19'"));
	...
	// Bind overlap event
	TriggerSphere->OnComponentBeginOverlap.AddDynamic(this, &AOB_Altar_Muerte::OnTriggerBeginOverlap);
}

// Called when the game starts or when spawned
void AOB_Altar_Muerte::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOB_Altar_Muerte::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AOB_Altar_Muerte::OnTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, 
