...
#include "Gema.generated.h"

UCLASS()
class GAME_TERRO_WGJ_API AGema : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Mesh component for the gema
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Gema Components")
	UStaticMeshComponent* GemaMesh;
