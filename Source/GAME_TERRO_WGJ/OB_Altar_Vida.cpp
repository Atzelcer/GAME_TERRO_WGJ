...
#include "OB_Altar_Vida.h"
#include "UObject/ConstructorHelpers.h"
#include "Engine/Engine.h"
#include "GAME_TERRO_WGJCharacter.h"

// Sets default values
AOB_Altar_Vida::AOB_Altar_Vida()
{
	...
	// Load vida particle system
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ParticleAsset(TEXT("ParticleSystem'/Game/MagicCircles2/ParticleSystems/PS_MagicCircle_13.PS_MagicCircle_13'"));
	...
	// Bind overlap event
	TriggerSphere->OnComponentBeginOverlap.AddDynamic(this, &AOB_Altar_Vida::OnTriggerBeginOverlap);
}

// Called when the game starts or when spawned
void AOB_Altar_Vida::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOB_Altar_Vida::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AOB_Altar_Vida::OnTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, 
