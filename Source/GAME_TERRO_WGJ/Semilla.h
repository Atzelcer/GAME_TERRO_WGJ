...
#include "Semilla.generated.h"

UCLASS()
class GAME_TERRO_WGJ_API ASemilla : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Mesh component for the semilla
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Semilla Components")
	UStaticMeshComponent* SemillaMesh;
