...
#include "lagrima_divina.generated.h"

UCLASS()
class GAME_TERRO_WGJ_API Alagrima_divina : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Mesh component for the lagrima divina
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Lagrima Components")
	UStaticMeshComponent* LagrimaMesh;
