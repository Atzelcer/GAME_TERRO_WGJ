...
enum class ETeleporterType : uint8
{
	...
	BosqueToAldea		UMETA(DisplayName = "Bosque → Aldea"),
	AldeaToCatacumbas	UMETA(DisplayName = "Aldea → Catacumbas"),
	CatacumbasToBosque	UMETA(DisplayName = "Catacumbas → Bosque")
};

UCLASS()
class GAME_TERRO_WGJ_API ATeleporter : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION(BlueprintCallable, Category = "Teleporter")
	void ConfigureDestinationByType();
