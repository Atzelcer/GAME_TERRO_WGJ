...
#include "Flor.generated.h"

UCLASS()
class GAME_TERRO_WGJ_API AFlor : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Mesh component for the flor
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Flor Components")
	UStaticMeshComponent* FlorMesh;
