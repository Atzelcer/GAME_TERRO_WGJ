...
#include "Daga.generated.h"

UCLASS()
class GAME_TERRO_WGJ_API ADaga : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Mesh component for the daga
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Daga Components")
	UStaticMeshComponent* DagaMesh;
